          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Link href="/profile/edit">
                  <Button size="sm" className="bg-blue-900 hover:bg-blue-950 text-white">{t.common.editProfile}</Button>
                </Link>
              </div>
              <Card>
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/positions/new">
                <Button size="sm" className="bg-blue-900 hover:bg-blue-950 text-white">{t.dashboard.positions.postButton}</Button>
              </Link>
            </div>
