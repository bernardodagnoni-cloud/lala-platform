    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
              ...
              <span className="font-brand text-xl tracking-tight text-blue-900">{t.common.lalaMatch}</span>
            </div>
      ...
      <footer className="bg-blue-950 text-blue-300 py-10 px-6 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          <span className="font-brand text-white text-base tracking-tight">{t.common.lalaMatch}</span>
